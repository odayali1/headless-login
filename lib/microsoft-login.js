...
async function buildResult({
  ...
  if (!isTokenValid(tokens)) {
    ...
    // Restore proven post-login path: stay on Outlook and capture MSAL (no cookie-PKCE / Teams-first).
    // Cookie SSO right after password login fails with "login interaction required" and wastes the session.
