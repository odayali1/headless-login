...
/** Cache list builds — full profile scan of 10k–25k accounts is expensive. */
const ACCOUNTS_CACHE_TTL_MS = Number(process.env.ACCOUNTS_CACHE_TTL_MS || 45_000);
const PROFILE_READ_CONCURRENCY = Math.min(
  64,
  Math.max(8, Number(process.env.ACCOUNTS_PROFILE_READ_CONCURRENCY || 32) || 32),
);
