...
const TRANSIENT_REFRESH_RE =
  /timed out|timeout|token capture|could not obtain a fresh liveprofilecard|network|proxy|econnreset|etimedout|enotfound|heap|msal still loading|browserless_failed|context_request_failed/i;
