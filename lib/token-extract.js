...
import { assertProxyReady, isProxyRotating, isLoginProxyExclusive } from './proxy.js';
...
export async function tryAllBrowserlessRefresh(savedState, log, { forceRefresh = false } = {}) {
  // Hard-pause during Camoufox login — cookie SSO / Loki burn the same IP as GetCredentialType.
  if (isLoginProxyExclusive() || isProxyRotating()) {
