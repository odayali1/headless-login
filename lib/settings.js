 ...
 * Port 10000 = sticky (~30 min). `__cr.us` forces United States exits
 * (without it the worldwide pool can land anywhere, e.g. Jordan/Amman).
 * Docs: https://docs.dataimpulse.com/proxies/parameters
 */
