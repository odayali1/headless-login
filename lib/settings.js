...
/** IPv6 rotating US — Camoufox login test (host:port:user:pass). */
export const BUILT_IN_IPV6_ROTATING_US_PROXY_URL =
  'socks5://91.217.90.225:62509:YNtVtMrf:NedyYDqp';
/**
...
export const BUILT_IN_PROXY_PRESETS = Object.freeze([
  ...
  Object.freeze({
    id: 'ipv6-rotating-us',
    name: 'IPv6 rotating US',
    kind: 'residential',
    url: BUILT_IN_IPV6_ROTATING_US_PROXY_URL,
    rotateUrl: null,
  }),
]);
