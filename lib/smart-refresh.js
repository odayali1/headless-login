...
/**
 * Fast lane HARD-PAUSES during login (user logs: Loki beside GetCredentialType → gct=429).
 * Keep-alive resumes when the login queue is idle. Camoufox slow lane stays deferred too.
 */
