...
export async function dismissSecurityPrompts(page, log, { skipBackupEmail = true } = {}) {
...
export async function dismissOutlookBlockingPrompts(page, log, { skipBackupEmail = true, maxRounds = 6 } = {}) {
  let last = 'none';
  for (let i = 0; i < maxRounds; i++) {
    const r = await dismissSecurityPrompts(page, log, { skipBackupEmail });
    last = r;
