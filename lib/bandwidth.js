 ...
 * @param {{ enabled?: boolean }} [opts] - enabled=false for password login (Playwright route() can soft-flag GetCredentialType).
 */
export async function attachBandwidthSaver(context, { enabled = true } = {}) {
